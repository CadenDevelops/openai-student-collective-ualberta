export const DISCORD_NAME = "OpenAI Student Collective";
export const DISCORD_AVATAR_URL = "https://openai-student-collective-ualberta.vercel.app/openai-webhook.png";
