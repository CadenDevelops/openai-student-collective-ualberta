...
export function SocialIcon({ kind }: { kind: "discord" | "luma" | "instagram" | "linkedin" }) {
  if (kind === "linkedin") return <svg width="23" height="23" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="4" stroke="currentColor" strokeWidth="1.5"/><path d="M7.5 10.5V17m4-6.5V17m0-3.6c0-1.3.9-2.2 2.1-2.2s2.1.9 2.1 2.2V17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><circle cx="7.5" cy="7.4" r="1" fill="currentColor"/></svg>;
